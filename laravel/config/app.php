...
return [
    ...
    */
    ...
    // account
    'admin' => [
        'name' => env('ADMIN_ACCOUNT_NAME', 'TTS'),
        'email' => env('ADMIN_ACCOUNT_EMAIL', 'admin@gmail.com'),
    ...
    'address_pluscode' => env('COMPANY_ADDRESS_PLUS_CODE', 'Địa chỉ công ty của bạn'),
    'address' => env('COMPANY_ADDRESS', 'Địa chỉ công ty của bạn'),
    'phone' => env('COMPANY_PHONE', '+84 xxx xxx xxx'),
    'email' => env('COMPANY_EMAIL', 'email@example.com'),
    'facebook' => env('COMPANY_FACEBOOK', '#'),
    'zalo' => env('COMPANY_ZALO', '#'),
];
